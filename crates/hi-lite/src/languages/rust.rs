...
pub(crate) static RULES: RuleSet = RuleSet {
    ...
    keywords: &[
        ...
        "extern", "fn", "for", "if", "in", "let", "loop", "match", "mod", "move", "mut",
        "pub", "ref", "return", "static", "super", "trait", "type", "unsafe",
        "use", "where", "while", "yield",
    ],
    types: &[
        "Box", "Err", "None", "Ok", "Option", "Result", "Self", "Some", "String", "Vec", "bool",
        "char", "f32", "f64", "false", "i128", "i16", "i32", "i64", "i8", "impl", "isize", "str", "struct", "true",
