//! Guard the generated vocabulary region of `../hi-lite/src/languages/xsh.rs` against
...
fn xsh_lang_matches_registry() {
    ...
    .expect("reading ../hi-lite/src/languages/xsh.rs");
    ...
    assert_eq!(
        ...
        "../hi-lite/src/languages/xsh.rs is out of date with the registry at {}; run `make gen-xsh`",
        repo.display()
    );
}
